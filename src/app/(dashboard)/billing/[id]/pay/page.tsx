          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-1">
                ...
                {params.id?.toString().slice(0, 8).toUpperCase()}
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {paymentMethods.map((method) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-12 h-12 rounded-lg ${method.color} flex items-center justify-center mb-3`}
                          >
                    ...
                    {paymentMethod === "CASH" && (
                      <div className="text-center py-8">
                        ...
                        <p className="text-slate-600">
                          Cash payment will be recorded when you confirm.
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="pt-4 border-t">
                    <div className="flex items-start gap-2 text-blue-600 bg-blue-50 p-3 rounded-lg">
                      ...
                      <p className="text-sm">
                        Payment will be processed securely. A receipt will be
                        generated upon successful transaction.
                      </p>
                    </div>
                  </div>
                </CardContent>
