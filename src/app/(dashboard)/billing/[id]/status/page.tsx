            ...
            >
              <Card className="border-none shadow-lg">
                <CardHeader className="bg-gradient-to-r from-purple-50 to-blue-50">
                  ...
                  <CardDescription>
                    Choose the appropriate status for this invoice
                  </CardDescription>
                </CardHeader>
                    ...
                    {statuses.map((status) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div
                              className={`w-14 h-14 rounded-lg ${status.color} flex items-center justify-center`}
                            >
                    ...
                    {bill &&
                      (() => {
                        const currentStatus = statuses.find(
                          (s) => s.value === bill.status,
                        );
                        const StatusIcon = currentStatus?.icon || Clock;
                        return (
                          <div
                            className={`px-4 py-3 rounded-lg border-2 ${currentStatus?.color} flex items-center gap-2`}
                          >
