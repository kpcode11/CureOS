...
export default function WardAssignmentsPage(){
  ...
  useEffect(()=>{ fetchWardAssignments(department).catch(()=>undefined); }, [department, fetchWardAssignments]);
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => fetchWardAssignments(department)}>Refresh</Button>
          </div>
        </div>
