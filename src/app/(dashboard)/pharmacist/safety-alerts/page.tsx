        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="border-red-200 bg-red-50">
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  <div className="text-3xl font-bold text-red-900">{criticalItems.length}</div>
          ...
          >
            <Card className="border-amber-200 bg-amber-50">
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  <div className="text-3xl font-bold text-amber-900">{warningItems.length}</div>
          ...
          >
            <Link href="/pharmacist/inventory">
              <Card className="border-blue-200 bg-blue-50 hover:shadow-lg transition-all cursor-pointer">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-medium text-blue-800">Action Required</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-between">
                    <div className="text-3xl font-bold text-blue-900">{lowStockItems.length}</div>
            ...
            <Card className="border-green-200 bg-green-50">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-green-700">
                  No low stock alerts at this time. All inventory levels are adequate.
                </p>
              </CardContent>
            </Card>
          </motion.div>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex-1">
                                ...
                                <p className="text-sm text-slate-600">
                                  Category: {item.category} | Min Stock: {item.minStock} {item.unit}
                                </p>
                              </div>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {warningItems.map((item, index) => {
                        const severity = getSeverity(item);
                        const SeverityIcon = severity.icon;
                        const percentRemaining = ((item.quantity / item.minStock) * 100).toFixed(0);
