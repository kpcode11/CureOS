  ...
  return (
    <div className="space-y-6">
      ...
      {systemRoles.length > 0 && (
        <div>
          <h3 className="text-lg font-semibold text-gray-800 mb-3">System Roles</h3>
                ...
                <div className="flex flex-wrap gap-2">
                  {role.rolePermissions.length > 0 ? (
                    role.rolePermissions.map((rp) => (
                      <span key={rp.id} className="inline-block px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded">
                        {rp.permission.name}
                      </span>
                    ))
                  ) : (
      ...
      {customRoles.length > 0 && (
        <div>
          <h3 className="text-lg font-semibold text-gray-800 mb-3">Custom Roles</h3>
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-3">Assign Permissions</label>
