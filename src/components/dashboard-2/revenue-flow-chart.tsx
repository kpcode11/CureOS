...
const insights = [
  ...
  "Emergency department contributed 28% of total revenue",
  "Surgical procedures show consistent growth",
  "Q1 total: ₹1,31,500 - up 15% year over year from patient care",
];
      ...
      <div className="space-y-1 sm:space-y-1.5">
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <span className="text-[10px] sm:text-sm font-medium text-foreground">
            ₹{Number(thisYear).toLocaleString('en-IN')}
          </span>
        </div>
        <div className="flex items-center gap-1.5 sm:gap-2">
          <div
          ...
          <span className="text-[10px] sm:text-sm font-medium text-foreground">
            ₹{Number(prevYear).toLocaleString('en-IN')}
          </span>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-10 flex-1 min-h-0">
        <div className="flex flex-col gap-4 w-full lg:w-[200px] xl:w-[220px] shrink-0">
          ...
          <div className="bg-muted/50 rounded-lg p-3 sm:p-4 space-y-3 sm:space-y-4">
            <p className="text-xs sm:text-sm font-semibold">� Top Revenue Source</p>
