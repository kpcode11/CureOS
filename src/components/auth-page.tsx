...
import { AtSignIcon, ChevronLeftIcon, Eye, EyeOff } from "lucide-react";
        ...
        <div className="z-10 mt-auto">
          <blockquote className="space-y-4 bg-background/20 backdrop-blur-sm p-6 rounded-xl border">
            ...
            <p className="text-lg text-muted-foreground">
              CureOS is the home of healthcare innovation, delivering amazing
              patient care, and empowering medical teams. Experience seamless
              healthcare management with us.
            </p>
                  ...
                  >
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="w-full rounded-3xl pr-12"
                        value={password}
